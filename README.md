...
I'm passionate about building modern web applications from frontend to backend. I enjoy learning new technologies, solving problems, and creating useful projects to improve my skills every day.
...
`HTML` • `CSS` • `JavaScript` • `TypeScript` • `React` • `Laravel` • `PHP` • `REST API` • `Git` • `GitHub` • `Docker`
...
A web application that provides anime streaming and anime information. This project was built to improve my full-stack web development skills.

[![Visit Website](https://img.shields.io/badge/Visit%20Website-38BDF8?style=for-the-badge&logo=vercel&logoColor=white)](https://ndifora.vercel.app)
...
<p align="left">
  <a href="mailto:dikacanda405@gmail.com">
...
> **"Keep learning. Keep building. Every project is a step toward becoming a better developer."**
